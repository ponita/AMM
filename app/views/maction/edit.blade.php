...
@section("content")
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			@endif
			{{ Form::model($maction, array('route' => array('maction.update', $maction->id), 
				'method' => 'PUT', 'id' => 'form-edit-maction')) }}
				<div class="panel panel-info">
			<div class="panel-body">
                
				<div class="row view-striped">
					<div class=""><strong>{{ $maction->action }}: </strong></div>
				</div>

				<div class="row view-striped">
					<strong>Solution</strong><br>
					<ul>
					@foreach ($maction->solution as $solution)
			...
			{{ Form::hidden('event_action_id', $maction->id) }}
