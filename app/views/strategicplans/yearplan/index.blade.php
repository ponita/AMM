...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<table class="table table-striped table-hover table-condensed search-table" id="myTable">
			<thead>
				<tr class="parent-grid-row scrolly_table" id="scrolling_table_1" style="max-width:500px; max-height:200px">
					 
					<th style="display:none;">#</th>
					<th style="background-color:white" class="fixed freeze_vertical">Objective</th>
					<th style="background-color:white" class="fixed freeze_vertical">Strategies</th>
					<th style="background-color:white" class="fixed freeze_vertical">Strategic indicator</th>
					<th style="background-color:white" class="fixed freeze_vertical">Funder</th>
					<th style="background-color:white" class="fixed freeze_vertical">Grant/ Sub Grant Activities</th>
					<th style="background-color:white" class="fixed freeze_vertical">Grant/ Sub Grant Sub Activities</th>
					<th style="background-color:white" class="fixed freeze_vertical">Location</th>
					<th style="background-color:white" class="fixed freeze_vertical">Target</th>
					<th style="background-color:white" class="fixed freeze_vertical">Person responsible</th>
					<th>Timeline</th>
				</tr>
			</thead>
			<tbody>
