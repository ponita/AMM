...
@section("content")
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			@endif
			{{ Form::model($yearplan, array('route' => array('yearplan.update', $yearplan->id), 
				'method' => 'PUT', 'id' => 'form-edit-yearplan')) }}
				
				<div class="panel panel-info">
			<div class="panel-body">
				<div class="row view-striped">
					<div class=""><strong>
					 @if($yearplan->thematicArea_id)
          {{ $yearplan->thematicarea->name }}
        @endif</strong></div>
    </div>
				<div class="row view-striped">
    			
					<div class=""><strong>{{ $yearplan->name }}</strong></div>
				</div>
  ...
  <?php
    $i = 0;
    foreach ($yearplan->workplan as $workplan) {
        echo "<tr>";
