@section ("loginHeader")
    ...
    <h3 align="center"><font color="black"> ACTIVITY TRACKING MODULE</font></h3>
    <p align="center"><i><font color ="black">Towards quality based planning and decision making</font></i></p>
@show
